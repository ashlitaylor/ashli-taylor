...
<table>
<thead><tr><th scope=col>ï..Year</th><th scope=col>Ashview.Heights</th><th scope=col>Dixie.Hills</th><th scope=col>Grove.Park</th><th scope=col>Orchard.Knob</th></tr></thead>
<tbody>
...
![png](/images/atlh4h//images/atlh4h/output_9_0.png)
...
![png](/images/atlh4h//images/atlh4h/output_10_0.png)



![png](/images/atlh4h//images/atlh4h/output_10_1.png)



![png](/images/atlh4h//images/atlh4h/output_10_2.png)



![png](/images/atlh4h//images/atlh4h/output_10_3.png)



![png](/images/atlh4h//images/atlh4h/output_10_4.png)



![png](/images/atlh4h//images/atlh4h/output_10_5.png)



![png](/images/atlh4h//images/atlh4h/output_10_6.png)



![png](/images/atlh4h//images/atlh4h/output_10_7.png)
...
![png](/images/atlh4h//images/atlh4h/output_11_0.png)
...
![png](/images/atlh4h//images/atlh4h/output_12_0.png)
...
![png](/images/atlh4h//images/atlh4h/output_13_0.png)
...
![png](/images/atlh4h//images/atlh4h/output_17_0.png)



![png](/images/atlh4h//images/atlh4h/output_17_1.png)



![png](/images/atlh4h//images/atlh4h/output_17_2.png)



![png](/images/atlh4h//images/atlh4h/output_17_3.png)
...
![png](/images/atlh4h//images/atlh4h/output_18_0.png)



![png](/images/atlh4h//images/atlh4h/output_18_1.png)



![png](/images/atlh4h//images/atlh4h/output_18_2.png)



![png](/images/atlh4h//images/atlh4h/output_18_3.png)



![png](/images/atlh4h//images/atlh4h/output_18_4.png)



![png](/images/atlh4h//images/atlh4h/output_18_5.png)



![png](/images/atlh4h//images/atlh4h/output_18_6.png)



![png](/images/atlh4h//images/atlh4h/output_18_7.png)
...
```R
time.pts = c(1:length(temp_Ashview.Heights))
time.pts = c(time.pts - min(time.pts))/max(time.pts)

## Parametric Quadratic Polynomial
x1 = time.pts
x2 = time.pts^2
lm.fit.AH = lm(temp_Ashview.Heights ~ x1 + x2)
summary(lm.fit.AH)
temp.fit.lm.AH = ts(fitted(lm.fit.AH), start = 2007, frequency = 1)

## Local Polynomial
loc.fit.AH = loess(temp_Ashview.Heights ~ time.pts)
temp.fit.loc.AH = ts(fitted(loc.fit.AH), start = 2007, frequency = 1)
summary(loc.fit.AH)

## Splines
library(mgcv)
gam.fit.AH = gam(temp_Ashview.Heights ~ s(time.pts))
temp.fit.gam.AH = ts(fitted(gam.fit.AH), start = 2007, frequency = 1)
summary(gam.fit.AH)
```


```R
### Plotting the original time series + the fitted values from the four models
plot(temp_Ashview.Heights, type = 'l', lwd = 2, main = 'Ashview Heights Median property values', ylab = 'Property Value')
lines(temp.fit.lm.AH, lwd = 1, col = 'green')
lines(temp.fit.loc.AH, lwd = 1, col = 'red')
lines(temp.fit.gam.AH, lwd = 1, col = 'blue')

d=par("usr") #grabs the plotting region dimensions
legend(d[1]+6,5.7, 
c("Parametric quadratic polynomial",
...
```R
time.pts = c(1:length(temp_Dixie.Hills))
time.pts = c(time.pts - min(time.pts))/max(time.pts)

## Parametric Quadratic Polynomial
x1 = time.pts
x2 = time.pts^2
lm.fit.DH = lm(temp_Dixie.Hills ~ x1 + x2)
summary(lm.fit.DH)
temp.fit.lm.DH = ts(fitted(lm.fit.DH), start = 2007, frequency = 1)

## Local Polynomial
loc.fit.DH = loess(temp_Dixie.Hills ~ time.pts)
temp.fit.loc.DH = ts(fitted(loc.fit.DH), start = 2007, frequency = 1)
summary(loc.fit.DH)

## Splines
library(mgcv)
gam.fit.DH = gam(temp_Dixie.Hills ~ s(time.pts))
temp.fit.gam.DH = ts(fitted(gam.fit.DH), start = 2007, frequency = 1)
summary(gam.fit.DH)
```
...
```R
### Plotting the original time series + the fitted values from the four models
plot(temp_Dixie.Hills, type = 'l', lwd = 2, main = 'Dixie Hills Median property values', ylab = 'Property Value')
lines(temp.fit.lm.DH, lwd = 1, col = 'green')
lines(temp.fit.loc.DH, lwd = 1, col = 'red')
lines(temp.fit.gam.DH, lwd = 1, col = 'blue')
...
```R
time.pts = c(1:length(temp_Grove.Park))
time.pts = c(time.pts - min(time.pts))/max(time.pts)

## Parametric Quadratic Polynomial
x1 = time.pts
x2 = time.pts^2
lm.fit.GP = lm(temp_Grove.Park ~ x1 + x2)
summary(lm.fit.GP)
temp.fit.lm.GP = ts(fitted(lm.fit.GP), start = 2007, frequency = 1)

## Local Polynomial
loc.fit.GP = loess(temp_Grove.Park ~ time.pts)
temp.fit.loc.GP = ts(fitted(loc.fit.GP), start = 2007, frequency = 1)
summary(loc.fit.GP)

## Splines
library(mgcv)
gam.fit.GP = gam(temp_Grove.Park ~ s(time.pts))
temp.fit.gam.GP = ts(fitted(gam.fit.GP), start = 2007, frequency = 1)
summary(gam.fit.GP)
```
...
```R
### Plotting the original time series + the fitted values from the four models
plot(temp_Grove.Park, type = 'l', lwd = 2, main = 'Grove Park Median property values', ylab = 'Property Value')
lines(temp.fit.lm.GP, lwd = 1, col = 'green')
lines(temp.fit.loc.GP, lwd = 1, col = 'red')
lines(temp.fit.gam.GP, lwd = 1, col = 'blue')
...
```R
time.pts = c(1:length(temp_Orchard.Knob))
time.pts = c(time.pts - min(time.pts))/max(time.pts)

## Parametric Quadratic Polynomial
x1 = time.pts
x2 = time.pts^2
lm.fit.OK = lm(temp_Orchard.Knob ~ x1 + x2)
summary(lm.fit.OK)
temp.fit.lm.OK = ts(fitted(lm.fit.OK), start = 2007, frequency = 1)

## Local Polynomial
loc.fit.OK = loess(temp_Orchard.Knob ~ time.pts)
temp.fit.loc.OK = ts(fitted(loc.fit.OK), start = 2007, frequency = 1)
summary(loc.fit.OK)

## Splines
library(mgcv)
gam.fit.OK = gam(temp_Orchard.Knob ~ s(time.pts))
temp.fit.gam.OK = ts(fitted(gam.fit.OK), start = 2007, frequency = 1)
summary(gam.fit.OK)
```
...
```R
### Plotting the original time series + the fitted values from the four models
plot(temp_Orchard.Knob, type = 'l', lwd = 2, main = 'Orchard Knob Median property values', ylab = 'Property Value')
lines(temp.fit.lm.OK, lwd = 1, col = 'green')
lines(temp.fit.loc.OK, lwd = 1, col = 'red')
lines(temp.fit.gam.OK, lwd = 1, col = 'blue')
...
```R
### Ashview Heights ###
resids.fit.lm.AH = residuals(lm.fit.AH)
resids.fit.loc.AH = residuals(loc.fit.AH)
resids.fit.gam.AH = residuals(gam.fit.AH)

par(mfrow=c(1,2))

plot(temp.fit.lm.AH, as.numeric(resids.fit.lm.AH),main="Parametric Quadratic Polynomial \nResiduals vs Fitted",xlab="fitted",ylab="residuals")
acf(as.numeric(resids.fit.lm.AH), main="ACF of Parametric Quadratic \nPolynomial Residuals")

plot(temp.fit.loc.AH, as.numeric(resids.fit.loc.AH),main="Local Polynomial \nResiduals vs Fitted",xlab="fitted",ylab="residuals")
acf(as.numeric(resids.fit.loc.AH), main="ACF of Local \nPolynomial Residuals")

plot(temp.fit.gam.AH, as.numeric(resids.fit.gam.AH),main="Splines Residuals \nvs Fitted",xlab="fitted",ylab="residuals")
acf(as.numeric(resids.fit.gam.AH), main="ACF of Splines \nResiduals")
```
...
```R
### Dixie Hills ###
resids.fit.lm.DH = residuals(lm.fit.DH)
resids.fit.loc.DH = residuals(loc.fit.DH)
resids.fit.gam.DH = residuals(gam.fit.DH)

par(mfrow=c(1,2))

plot(temp.fit.lm.DH, as.numeric(resids.fit.lm.DH),main="Parametric Quadratic Polynomial \nResiduals vs Fitted",cex=0.3,xlab="fitted",ylab="residuals")
acf(as.numeric(resids.fit.lm.DH), main="ACF of Parametric Quadratic \nPolynomial Residuals",cex=0.3)

plot(temp.fit.loc.DH, as.numeric(resids.fit.loc.DH),main="Local Polynomial \nResiduals vs Fitted",cex=0.3,xlab="fitted",ylab="residuals")
acf(as.numeric(resids.fit.loc.DH), main="ACF of Local \nPolynomial Residuals",cex=0.3)

plot(temp.fit.gam.DH, as.numeric(resids.fit.gam.DH),main="Splines Residuals \nvs Fitted",cex=0.3,xlab="fitted",ylab="residuals")
acf(as.numeric(resids.fit.gam.DH), main="ACF of Splines \nResiduals",cex=0.3)
```
...
```R
### Grove Park ###
resids.fit.lm.GP = residuals(lm.fit.GP)
resids.fit.loc.GP = residuals(loc.fit.GP)
resids.fit.gam.GP = residuals(gam.fit.GP)

par(mfrow=c(1,2))

plot(temp.fit.lm.GP, as.numeric(resids.fit.lm.GP),main="Parametric Quadratic Polynomial \nResiduals vs Fitted",cex=0.3,xlab="fitted",ylab="residuals")
acf(as.numeric(resids.fit.lm.GP), main="ACF of Parametric Quadratic \nPolynomial Residuals",cex=0.3)

plot(temp.fit.loc.GP, as.numeric(resids.fit.loc.GP),main="Local Polynomial \nResiduals vs Fitted",cex=0.3,xlab="fitted",ylab="residuals")
acf(as.numeric(resids.fit.loc.GP), main="ACF of Local \nPolynomial Residuals",cex=0.3)

plot(temp.fit.gam.GP, as.numeric(resids.fit.gam.GP),main="Splines Residuals \nvs Fitted",cex=0.3,xlab="fitted",ylab="residuals")
acf(as.numeric(resids.fit.gam.GP), main="ACF of Splines \nResiduals",cex=0.3)
...
```R
### Orchard Knob ###
resids.fit.lm.OK = residuals(lm.fit.OK)
resids.fit.loc.OK = residuals(loc.fit.OK)
resids.fit.gam.OK = residuals(gam.fit.OK)

par(mfrow=c(1,2))

#Residuals plot
plot(temp.fit.lm.OK, as.numeric(resids.fit.lm.OK),main="Parametric Quadratic Polynomial \nResiduals vs Fitted",cex=0.3,xlab="fitted",ylab="residuals")
acf(as.numeric(resids.fit.lm.OK), main="ACF of Parametric Quadratic \nPolynomial Residuals",cex=0.3)

plot(temp.fit.loc.OK, as.numeric(resids.fit.loc.OK),main="Local Polynomial \nResiduals vs Fitted",cex=0.3,xlab="fitted",ylab="residuals")
acf(as.numeric(resids.fit.loc.OK), main="ACF of Local \nPolynomial Residuals",cex=0.3)

plot(temp.fit.gam.OK, as.numeric(resids.fit.gam.OK),main="Splines Residuals \nvs Fitted",cex=0.3,xlab="fitted",ylab="residuals")
acf(as.numeric(resids.fit.gam.OK), main="ACF of Splines \nResiduals",cex=0.3)
```

#### Forecasting
For all neighborhoods, the nonparametric model fit the trend best. So I moved forward with the Splines model for all projections for the median neighborhood property values. 

Below are the projections/predictions:


```R
temp_Ashview.Heights.last = temp_Ashview.Heights[1:8]
temp_Ashview.Heights.last
time.pts.last = time.pts[1:8]
time.pts.last
```
...
```R
gam.fit.AH.last = gam(temp_Ashview.Heights.last ~ s(time.pts.last))
temp.fit.gam.AH.last = ts(fitted(gam.fit.AH.last), start = 2007, frequency = 1)
```
    ...
    1. gam(temp_Ashview.Heights.last ~ s(time.pts.last))
    ...
    3. gam.setup(formula = structure(list(pf = temp_Ashview.Heights.last ~ 
     .     1, pfok = 1, smooth.spec = list(structure(list(term = "time.pts.last", 
     .     bs.dim = -1, fixed = FALSE, dim = 1L, p.order = NA, by = "NA", 
     .     label = "s(time.pts.last)", xt = NULL, id = NULL, sp = NULL), class = "tp.smooth.spec")), 
     .     fake.formula = temp_Ashview.Heights.last ~ 1 + time.pts.last, 
     .     response = "temp_Ashview.Heights.last", fake.names = "time.pts.last", 
     .     pred.names = "time.pts.last", pred.formula = ~time.pts.last), class = "split.gam.formula"), 
     .     pterms = temp_Ashview.Heights.last ~ 1, data = structure(list(
     .         temp_Ashview.Heights.last = c(45040L, 45400L, 45020L, 
     .         37660L, 14980L, 6440L, 4400L, 10720L), time.pts.last = c(0, 
     .         0.0833333333333333, 0.166666666666667, 0.25, 0.333333333333333, 
     .         0.416666666666667, 0.5, 0.583333333333333)), terms = temp_Ashview.Heights.last ~ 
     .         1 + time.pts.last, row.names = c(NA, 8L), class = "data.frame"), 
...
```R
outpred_AH = predict.gam(gam.fit.AH.last,n.ahead=4, se.fit = TRUE)
outpred_AH$fit
outpred_AH$se.fit
```
...
```R
#Ashview
#Predictions for the last four years
n = length(temp_Ashview.Heights)
nfit = n-4
gam.fit.AH = gam()
outpred_AH = predict(gam.fit.AH,n.ahead=4, se.fit = TRUE)
ubound_AH = outpred_AH$fit +(1.96*outpred_AH$se.fit)
lbound_AH = outpred_AH$fit-(1.96*outpred_AH$se.fit)
ymin_AH = min(lbound_AH)
ymax_AH = max(ubound_AH)
#Plot of forecasted Property Values vs actual Property Values
plot(temp_Ashview.Heights,type="l", ylim=c(ymin_AH,ymax_AH), main = 'Median Property Values and \n predicted Median Property Values in Ashview Heights', xlab = "Year",ylab="Median Property Values")
points((ts(outpred_AH$fit, start = 2015, frequency = 1)),col="red")
lines((ts(ubound_AH, start = 2015, freq = 1)),lty=3,lwd= 2, col="blue")
lines((ts(lbound_AH, start = 2015, freq = 1)),lty=3,lwd= 2, col="blue")
legend(x=2007,y=65000,legend=c("Median Property Values","Predicted Median Property Values"), fill =c("black","red"))
## Compute Accuracy Measures
obsprice_AH = temp_Ashview.Heights[(nfit+1):n]
predprice_AH = outpred_AH$fit
### Mean Squared Prediction Error (MSPE)
MSPE_AH = mean((predprice_AH-obsprice_AH)^2)
### Mean Absolute Prediction Error (MAE)
MAE_AH = mean(abs(predprice_AH-obsprice_AH))
### Mean Absolute Percentage Error (MAPE)
MAPE_AH = mean(abs(predprice_AH-obsprice_AH)/obsprice_AH)
### Precision Measure (PM)
PM_AH = sum((predprice_AH-obsprice_AH)^2)/sum((obsprice_AH-mean(obsprice_AH))^2)
```
...
n = length(temp_Ashview.Heights)
nfit = n-4
outpred_AH = predict(gam.fit.AH,n.ahead=4)
ubound_AH = outpred_AH$pred +(1.96*outpred_AH$se)
lbound_AH = outpred_AH$pred-(1.96*outpred_AH$se)
ymin_AH = min(lbound_AH)
ymax_AH = max(ubound_AH)
#Plot of forecasted Property Values vs actual Property Values
par(mfrow=c(1,2))
plot(temp_Ashview.Heights,type="l", ylim=c(ymin_AH,ymax_AH), main = 'Median Property Values and \n predicted Median Property Values in Ashview Heights', xlab = "Year",ylab="Median Property Values")
points((ts(outpred_AH$pred, start = 2015, frequency = 1)),col="red")
lines((ts(ubound_AH, start = 2015, freq = 1)),lty=3,lwd= 2, col="blue")
lines((ts(lbound_AH, start = 2015, freq = 1)),lty=3,lwd= 2, col="blue")
legend(x=2007,y=65000,legend=c("Median Property Values","Predicted Median Property Values"), fill =c("black","red"))
## Compute Accuracy Measures
obsprice_AH = temp_Ashview.Heights[(nfit+1):n]
predprice_AH = outpred_AH$pred
### Mean Squared Prediction Error (MSPE)
MSPE_AH = mean((predprice_AH-obsprice_AH)^2)
### Mean Absolute Prediction Error (MAE)
MAE_AH = mean(abs(predprice_AH-obsprice_AH))
...
outprice_AH = gam(temp_Ashview.Heights ~ s(time.pts))
#outprice_AH = arima(temp_Ashview.Heights[1:nfit], order = final.order.Ash,method = "ML")
outpred_AH = predict(outprice_AH,n.ahead=5)   predict(gam.fit.AH,n.ahead=4)
ubound_Ashview = outpred_Ashview$pred +(1.96*outpred_Ashview$se)
lbound_Ashview = outpred_Ashview$pred-(1.96*outpred_Ashview$se)
ymin_Ashview = min(lbound_Ashview)
ymax_Ashview = max(ubound_Ashview)
#Plot of forecasted Property Values vs actual Property Values
plot(temp_Ashview,type="l",xlim =c(2007,2024), ylim=c(ymin_Ashview,ymax_Ashview), main = 'Median Property Values and \n Forecasted Median Property Values in Ashview', xlab = "Year",ylab="Median Property Values")
lines((ts(c(Ashview[12], outpred_Ashview$pred[1]), start = 2018, frequency = 1)),col="red")
lines((ts(outpred_Ashview$pred, start = 2019, frequency = 1)),col="red")
points((ts(outpred_Ashview$pred, start = 2019, frequency = 1)),col="red")
lines((ts(ubound_Ashview, start = 2019, freq = 1)),lty=3,lwd= 2, col="blue")
lines((ts(lbound_Ashview, start = 2019, freq = 1)),lty=3,lwd= 2, col="blue")
legend(x=2007,y=65000,legend=c("Median Property Values","Forecasted Median Property Values"), fill =c("black","red"))
```


    Error in parse(text = x, srcfile = src): <text>:35:47: unexpected symbol
    34: #outprice_AH = arima(temp_Ashview.Heights[1:nfit], order = final.order.Ash,method = "ML")
    35: outpred_AH = predict(outprice_AH,n.ahead=5)   predict
                                                      ^
    Traceback:
...
outpred_AH = predict.gam(gam.fit.AH,n.ahead=4, se.fit = TRUE)
ubound_AH = outpred_AH$fit +(1.96*outpred_AH$se.fit)
lbound_AH = outpred_AH$fit-(1.96*outpred_AH$se.fit)
ymin_AH = min(lbound_AH)
ymax_AH = max(ubound_AH)
#Plot of forecasted Property Values vs actual Property Values
plot(temp_Ashview.Heights,type="l",xlim =c(2007,2024), ylim=c(ymin_AH,ymax_AH), main = 'Median Property Values and \n Forecasted Median Property Values in Ashview', xlab = "Year",ylab="Median Property Values")
lines((ts(c(Ashview.Heights[12], outpred_AH$fit[1]), start = 2018, frequency = 1)),col="red")
lines((ts(outpred_AH$fit, start = 2019, frequency = 1)),col="red")
points((ts(outpred_AH$fit, start = 2019, frequency = 1)),col="red")
lines((ts(ubound_AH, start = 2019, freq = 1)),lty=3,lwd= 2, col="blue")
lines((ts(lbound_AH, start = 2019, freq = 1)),lty=3,lwd= 2, col="blue")
legend(x=2007,y=65000,legend=c("Median Property Values","Forecasted Median Property Values"), fill =c("black","red"))
```


![png](/images/atlh4h//images/atlh4h/output_47_0.png)
...
<dl>
	...
	<dt>1</dt>
		<dd>45147.0299859118</dd>
	<dt>2</dt>
		<dd>45801.4473611194</dd>
	<dt>3</dt>
		<dd>45058.500298438</dd>
	<dt>4</dt>
		<dd>34914.3489307102</dd>
	<dt>5</dt>
		<dd>17558.8799130763</dd>
	<dt>6</dt>
		<dd>6087.92205233509</dd>
	<dt>7</dt>
		<dd>5439.78155725593</dd>
	<dt>8</dt>
		<dd>9348.26733560614</dd>
	<dt>9</dt>
		<dd>11362.0346054246</dd>
	<dt>10</dt>
		<dd>10943.1791736243</dd>
	<dt>11</dt>
		<dd>11362.7714143688</dd>
	<dt>12</dt>
		<dd>14075.8373721279</dd>
</dl>
</dd>
	<dt>$se.fit</dt>
		<dd><dl class=dl-horizontal>
	<dt>1</dt>
		<dd>2006.24506680754</dd>
	<dt>2</dt>
		<dd>1698.95253673302</dd>
	<dt>3</dt>
		<dd>1608.88727120719</dd>
	<dt>4</dt>
		<dd>1577.24884740176</dd>
	<dt>5</dt>
		<dd>1589.57988483094</dd>
	<dt>6</dt>
		<dd>1614.124085572</dd>
	<dt>7</dt>
		<dd>1614.12408557198</dd>
	<dt>8</dt>
		<dd>1589.57988483092</dd>
	<dt>9</dt>
		<dd>1577.24884740171</dd>
	<dt>10</dt>
		<dd>1608.88727120722</dd>
	<dt>11</dt>
		<dd>1698.95253673318</dd>
	<dt>12</dt>
		<dd>2006.24506680751</dd>
</dl>
</dd>
</dl>
...
```
    ...
    1. AIC(arima(diff.Ashview.Heights, order = c(p, d, q), method = "ML"))

    2. arima(diff.Ashview.Heights, order = c(p, d, q), method = "ML")
...
```
    ...
    1. AIC(arima(diff.Dixie.Hills, order = c(p, d, q)))

    2. arima(diff.Dixie.Hills, order = c(p, d, q))
    ...
    4. stop("non-stationary AR part from CSS")
...
```
    ...
    1. AIC(arima(diff.Grove.Park, order = c(p, d, q)))

    2. arima(diff.Grove.Park, order = c(p, d, q))
...
```
    ...
    1. AIC(arima(diff.Orchard.Knob, order = c(p, d, q)))

    2. arima(diff.Orchard.Knob, order = c(p, d, q))
...
![png](/images/atlh4h//images/atlh4h/output_63_2.png)



![png](/images/atlh4h//images/atlh4h/output_63_3.png)



![png](/images/atlh4h//images/atlh4h/output_63_4.png)



![png](/images/atlh4h//images/atlh4h/output_63_5.png)
...
![png](/images/atlh4h//images/atlh4h/output_64_2.png)



![png](/images/atlh4h//images/atlh4h/output_64_3.png)



![png](/images/atlh4h//images/atlh4h/output_64_4.png)



![png](/images/atlh4h//images/atlh4h/output_64_5.png)
...
![png](/images/atlh4h//images/atlh4h/output_65_2.png)



![png](/images/atlh4h//images/atlh4h/output_65_3.png)



![png](/images/atlh4h//images/atlh4h/output_65_4.png)



![png](/images/atlh4h//images/atlh4h/output_65_5.png)
...
![png](/images/atlh4h//images/atlh4h/output_66_2.png)



![png](/images/atlh4h//images/atlh4h/output_66_3.png)



![png](/images/atlh4h//images/atlh4h/output_66_4.png)



![png](/images/atlh4h//images/atlh4h/output_66_5.png)
...
![png](/images/atlh4h//images/atlh4h/output_69_0.png)
...
![png](/images/atlh4h//images/atlh4h/output_70_0.png)
...
![png](/images/atlh4h//images/atlh4h/output_71_0.png)
...
![png](/images/atlh4h//images/atlh4h/output_72_0.png)
...
![png](/images/atlh4h//images/atlh4h/output_74_0.png)
...
![png](/images/atlh4h//images/atlh4h/output_76_0.png)
...
![png](/images/atlh4h//images/atlh4h/output_78_0.png)
...
![png](/images/atlh4h//images/atlh4h/output_80_0.png)
