...
I list the seven best movies (highest scores) sorted by score from highest to lowest, then by name in alphabetical order. 

##### Most Prolific actors
I list the five cast members with the highest number of movie appearances (movie_count).The number of appearances is sorted from highest to lowes. In the case of a tie in the number of appearances, I sort the results of cast_name in alphabetical order. 
