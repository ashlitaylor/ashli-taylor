...
The [Bitcoin OTC trust weighted signed network](https://snap.stanford.edu/data/soc-sign-bitcoin-otc.html) is a who-trusts-whom network of people who trade using the platform, and is comprised of almost 6,000 nodes and over 35,000 edges. I created a Resilient Distributed Dataset (RDD) from the bitcoinotc.csv file and convert it to a dataframe.
